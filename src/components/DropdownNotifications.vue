        ...
        >
          <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
            <router-link class="block py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" to="#0" @click="dropdownOpen = false">
              <span class="block text-sm mb-2">📣 <span class="font-medium text-gray-800 dark:text-gray-100">Hello</span> ceci est une notification</span>
              <span class="block text-xs font-medium text-gray-400 dark:text-gray-500">5 Juillet 2024</span>
            </router-link>
          </li>
          <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
            <router-link class="block py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" to="#0" @click="dropdownOpen = false">
